...
Public Class CryLapDataDosenPengampu
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CryLapDataDosenPengampu.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DbPenjadwalan24022.CryLapDataDosenPengampu.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryLapDataDosenPengampu
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryLapDataDosenPengampu = New CryLapDataDosenPengampu()
        rpt.Site = Me.Site
        Return rpt
    End Function
