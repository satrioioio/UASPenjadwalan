...
Public Class CryLapDataDosen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DbPenjadwalan24022.CryLapDataDosen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryLapDataDosen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryLapDataDosen = New CryLapDataDosen()
        rpt.Site = Me.Site
        Return rpt
    End Function
