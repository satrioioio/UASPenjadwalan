...
Public Class CryLapDataMatkul
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DbPenjadwalan24022.CryLapDataMatkul.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryLapDataMatkul
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryLapDataMatkul = New CryLapDataMatkul()
        rpt.Site = Me.Site
        Return rpt
    End Function
